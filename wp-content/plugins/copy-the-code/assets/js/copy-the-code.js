...
(function ($) {
  CopyTheCode = {
    ...
    _initialize: function () {
      ...
      $(copyTheCode.selectors).each(function (index, el) {
        ...
        $(selector).each(function (index, single_selector) {
          var buttonMarkup = CopyTheCode._getButtonMarkup(
            button_title,
            button_text,
            style
          );
          ...
          if ("cover" !== style && "outside" === button_position) {
            $(single_selector).wrap(
              '<span data-copy-format="' +
                copy_format +
                '" data-button-text="' +
                button_text +
                '" data-button-position="' +
                button_position +
                '" data-button-copy-text="' +
                button_copy_text +
                '" data-style="' +
                style +
                '" data-button-title="' +
                ...
                '" data-selector="' +
                selector +
                '" class="copy-the-code-wrap copy-the-code-style-' +
                style +
                ' copy-the-code-outside-wrap"></span>'
            );
            $(single_selector)
              .parent()
              .prepend(
                '<div class="copy-the-code-outside">' + buttonMarkup + "</div>"
              );
          } else {
            $(single_selector).wrap(
              '<span data-copy-format="' +
                ...
                '" class="copy-the-code-wrap copy-the-code-style-' +
                style +
                ' copy-the-code-inside-wrap"></span>'
            );
          ...
          switch (style) {
            case "svg-icon":
              $(single_selector)
                .find(".copy-the-code-button")
                .html(copyTheCode.buttonSvg);
              break;
            case "cover":
            case "button":
            default:
    ...
    _getButtonMarkup: function (button_title, button_text, style) {
      ...
      return (
        '<button class="copy-the-code-button" data-style="' +
        style +
        '" title="' +
        button_title +
        '">' +
    ...
    copyShortcode: function (event) {
      ...
      var btn = $(this),
        ...
        copy_content_as =
          btn.attr("data-copy-as") || copyTheCode.copy_content_as,
